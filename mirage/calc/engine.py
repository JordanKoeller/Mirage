...
from mirage.util import Vec2D, DuplexChannel
...
class Engine:
  ...
  def blocking_run_simulation(self, simulation: Simulation):
    with u.add_enabled_units([simulation.lensing_system.theta_0, simulation.lensing_system.xi_0, simulation.lensing_system.einstein_radius]):
