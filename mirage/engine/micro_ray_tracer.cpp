...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "engine.micro_ray_tracer",
        "sources": [
            "engine/micro_ray_tracer.pyx"
        ]
    },
    "module_name": "engine.micro_ray_tracer"
}
END: Cython Metadata */
...
#define __PYX_HAVE__engine__micro_ray_tracer
#define __PYX_HAVE_API__engine__micro_ray_tracer
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
/* Module declarations from 'engine.micro_ray_tracer' */
...
static PyArrayObject *__pyx_f_6engine_16micro_ray_tracer_ray_trace(PyArrayObject *, double &, double &, int &, PyArrayObject *, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "engine.micro_ray_tracer"
extern int __pyx_module_is_main_engine__micro_ray_tracer;
int __pyx_module_is_main_engine__micro_ray_tracer = 0;

/* Implementation of 'engine.micro_ray_tracer' */
...
static PyObject *__pyx_pf_6engine_16micro_ray_tracer_ray_trace(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_rays, double __pyx_v_kap, double __pyx_v_gam, int __pyx_v_thread_count, PyArrayObject *__pyx_v_stars); /* proto */
...
/* "engine/micro_ray_tracer.pyx":10
 * 
...
static std::pair<double,double>  __pyx_f_6engine_16micro_ray_tracer_ray_trace_helper(double &__pyx_v_x, double &__pyx_v_y, double &__pyx_v_gMax, double &__pyx_v_gMin, double &__pyx_v_kap, int &__pyx_v_num_stars, __Pyx_memviewslice __pyx_v_stars) {
  int __pyx_v_s;
  double __pyx_v_dx;
  double __pyx_v_dy;
  double __pyx_v_retx;
  ...
  __Pyx_TraceCall("ray_trace_helper", __pyx_f[0], 10, 1, __PYX_ERR(0, 10, __pyx_L1_error));

  /* "engine/micro_ray_tracer.pyx":19
 *     cdef int s
 ...
 */
  ...
  /* "engine/micro_ray_tracer.pyx":20
 *     cdef double dx, dy, retx, rety, r
 *     retx = gMin*x - kap*x
 *     rety = y*gMax - kap*y             # <<<<<<<<<<<<<<
 *     for s in range(num_stars):
 ...
 */
  ...
  /* "engine/micro_ray_tracer.pyx":21
 *     retx = gMin*x - kap*x
 *     rety = y*gMax - kap*y
 *     for s in range(num_stars):             # <<<<<<<<<<<<<<
 *         dx = x - stars[s,0]
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "engine/micro_ray_tracer.pyx":22
 *     rety = y*gMax - kap*y
 *     for s in range(num_stars):
 *         dx = x - stars[s,0]             # <<<<<<<<<<<<<<
 *         dy = y - stars[s,1]
 ...
 */
    ...
    /* "engine/micro_ray_tracer.pyx":23
 *     for s in range(num_stars):
 *         dx = x - stars[s,0]
 *         dy = y - stars[s,1]             # <<<<<<<<<<<<<<
 *         r = dx*dx + dy*dy
 ...
 */
    __pyx_t_6 = __pyx_v_s;
    __pyx_t_7 = 1;
    __pyx_v_dy = (__pyx_v_y - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_stars.data + __pyx_t_6 * __pyx_v_stars.strides[0]) ) + __pyx_t_7 * __pyx_v_stars.strides[1]) ))));

    /* "engine/micro_ray_tracer.pyx":24
 *         dx = x - stars[s,0]
 *         dy = y - stars[s,1]
 *         r = dx*dx + dy*dy             # <<<<<<<<<<<<<<
 *         retx -= stars[s,2]*dx/r
 ...
 */
    ...
    /* "engine/micro_ray_tracer.pyx":25
 *         dy = y - stars[s,1]
 *         r = dx*dx + dy*dy
 *         retx -= stars[s,2]*dx/r             # <<<<<<<<<<<<<<
 *         rety -= stars[s,2]*dy/r
 ...
 */
    __pyx_t_8 = __pyx_v_s;
    __pyx_t_9 = 2;
    __pyx_t_10 = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_stars.data + __pyx_t_8 * __pyx_v_stars.strides[0]) ) + __pyx_t_9 * __pyx_v_stars.strides[1]) ))) * __pyx_v_dx);
    ...
    __pyx_v_retx = (__pyx_v_retx - (__pyx_t_10 / __pyx_v_r));

    /* "engine/micro_ray_tracer.pyx":26
 *         r = dx*dx + dy*dy
 *         retx -= stars[s,2]*dx/r
 *         rety -= stars[s,2]*dy/r             # <<<<<<<<<<<<<<
 *     return pair[double,double](retx,rety)
 ...
 */
    ...
    __pyx_t_12 = 2;
    __pyx_t_10 = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_stars.data + __pyx_t_11 * __pyx_v_stars.strides[0]) ) + __pyx_t_12 * __pyx_v_stars.strides[1]) ))) * __pyx_v_dy);
    if (unlikely(__pyx_v_r == 0)) {
      #ifdef WITH_THREAD
      PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
      #endif
    ...
    __pyx_v_rety = (__pyx_v_rety - (__pyx_t_10 / __pyx_v_r));
  }

  /* "engine/micro_ray_tracer.pyx":27
 *         retx -= stars[s,2]*dx/r
 *         rety -= stars[s,2]*dy/r
 *     return pair[double,double](retx,rety)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  try {
    __pyx_t_13 = std::pair<double,double> (__pyx_v_retx, __pyx_v_rety);
  } catch(...) {
    #ifdef WITH_THREAD
    PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
    #endif
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("engine.micro_ray_tracer.ray_trace_helper", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
...
/* "engine/micro_ray_tracer.pyx":29
 *     return pair[double,double](retx,rety)
 * 
 * cpdef np.ndarray[np.float64_t,ndim=3] ray_trace(np.ndarray[np.float64_t, ndim=3] rays,             # <<<<<<<<<<<<<<
 *         double &kap,
...
static PyObject *__pyx_pw_6engine_16micro_ray_tracer_1ray_trace(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyArrayObject *__pyx_f_6engine_16micro_ray_tracer_ray_trace(PyArrayObject *__pyx_v_rays, double &__pyx_v_kap, double &__pyx_v_gam, CYTHON_UNUSED int &__pyx_v_thread_count, PyArrayObject *__pyx_v_stars, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_j;
  ...
  __Pyx_TraceCall("ray_trace", __pyx_f[0], 29, 0, __PYX_ERR(0, 29, __pyx_L1_error));
  ...
  __pyx_pybuffernd_stars.rcbuffer = &__pyx_pybuffer_stars;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_rays.rcbuffer->pybuffer, (PyObject*)__pyx_v_rays, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 3, 0, __pyx_stack) == -1)) __PYX_ERR(0, 29, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_stars.rcbuffer->pybuffer, (PyObject*)__pyx_v_stars, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 29, __pyx_L1_error)
  }
  ...
  /* "engine/micro_ray_tracer.pyx":35
 ...
 */
  ...
  /* "engine/micro_ray_tracer.pyx":36
 *     cdef int i,j
 *     cdef int width = rays.shape[0]
 *     cdef int height = rays.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int num_stars = stars.shape[0]
 ...
 */
  ...
  /* "engine/micro_ray_tracer.pyx":37
 *     cdef int width = rays.shape[0]
 *     cdef int height = rays.shape[0]
 *     cdef int num_stars = stars.shape[0]             # <<<<<<<<<<<<<<
 *     cdef double gMin = 1.0 - gam
 ...
 */
  ...
  /* "engine/micro_ray_tracer.pyx":38
 *     cdef int height = rays.shape[0]
 *     cdef int num_stars = stars.shape[0]
 *     cdef double gMin = 1.0 - gam             # <<<<<<<<<<<<<<
 *     cdef double gMax = 1.0 + gam
 ...
 */
  ...
  /* "engine/micro_ray_tracer.pyx":39
 *     cdef int num_stars = stars.shape[0]
 *     cdef double gMin = 1.0 - gam
 *     cdef double gMax = 1.0 + gam             # <<<<<<<<<<<<<<
 *     cdef int s
 ...
 */
  ...
  /* "engine/micro_ray_tracer.pyx":42
 *     cdef int s
 *     cdef double dx, dy, retx, rety, r
                ...
                #endif /* _OPENMP */
                {
                    ...
                    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_3; __pyx_t_2++){
                        if (__pyx_parallel_why < 2)
                        {
                            ...
                            /* "engine/micro_ray_tracer.pyx":43
 *     cdef double dx, dy, retx, rety, r
 *     for i in prange(0,width,1,nogil=True,schedule='static',num_threads=thread_count):
 *         for j in range(0,height):             # <<<<<<<<<<<<<<
 *             rays[i,j,0] = gMin*rays[i,j,0] - kap*rays[i,j,0]
 ...
 */
                            ...
                            for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
                              ...
                              /* "engine/micro_ray_tracer.pyx":44
 *     for i in prange(0,width,1,nogil=True,schedule='static',num_threads=thread_count):
 *         for j in range(0,height):
 *             rays[i,j,0] = gMin*rays[i,j,0] - kap*rays[i,j,0]             # <<<<<<<<<<<<<<
 *             rays[i,j,1] = rays[i,j,1]*gMax - kap*rays[i,j,1]
 ...
 */
                              ...
                              __pyx_t_24 = 1;
                              *__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_rays.rcbuffer->pybuffer.buf, __pyx_t_22, __pyx_pybuffernd_rays.diminfo[0].strides, __pyx_t_23, __pyx_pybuffernd_rays.diminfo[1].strides, __pyx_t_24, __pyx_pybuffernd_rays.diminfo[2].strides) = (((*__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_rays.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_rays.diminfo[0].strides, __pyx_t_17, __pyx_pybuffernd_rays.diminfo[1].strides, __pyx_t_18, __pyx_pybuffernd_rays.diminfo[2].strides)) * __pyx_v_gMax) - (__pyx_v_kap * (*__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_rays.rcbuffer->pybuffer.buf, __pyx_t_19, __pyx_pybuffernd_rays.diminfo[0].strides, __pyx_t_20, __pyx_pybuffernd_rays.diminfo[1].strides, __pyx_t_21, __pyx_pybuffernd_rays.diminfo[2].strides))));

                              /* "engine/micro_ray_tracer.pyx":46
 *             rays[i,j,0] = gMin*rays[i,j,0] - kap*rays[i,j,0]
 *             rays[i,j,1] = rays[i,j,1]*gMax - kap*rays[i,j,1]
 *             for s in range(num_stars):             # <<<<<<<<<<<<<<
 *                 dx = rays[i,j,0] - stars[s,0]
 ...
 */
                              ...
                              for (__pyx_t_27 = 0; __pyx_t_27 < __pyx_t_26; __pyx_t_27+=1) {
                                ...
                                /* "engine/micro_ray_tracer.pyx":47
 *             rays[i,j,1] = rays[i,j,1]*gMax - kap*rays[i,j,1]
 *             for s in range(num_stars):
 *                 dx = rays[i,j,0] - stars[s,0]             # <<<<<<<<<<<<<<
 *                 dy = rays[i,j,1] - stars[s,1]
 ...
 */
                                ...
                                /* "engine/micro_ray_tracer.pyx":48
 *             for s in range(num_stars):
 *                 dx = rays[i,j,0] - stars[s,0]
 *                 dy = rays[i,j,1] - stars[s,1]             # <<<<<<<<<<<<<<
 *                 r = dx*dx + dy*dy
 ...
 */
                                ...
                                /* "engine/micro_ray_tracer.pyx":49
 *                 dx = rays[i,j,0] - stars[s,0]
 *                 dy = rays[i,j,1] - stars[s,1]
 *                 r = dx*dx + dy*dy             # <<<<<<<<<<<<<<
 *                 rays[i,j,0] -= stars[s,2]*dx/r
 ...
 */
                                ...
                                /* "engine/micro_ray_tracer.pyx":50
 *                 dy = rays[i,j,1] - stars[s,1]
 *                 r = dx*dx + dy*dy
 *                 rays[i,j,0] -= stars[s,2]*dx/r             # <<<<<<<<<<<<<<
 *                 rays[i,j,1] -= stars[s,2]*dy/r
 ...
 */
                                ...
                                __pyx_t_39 = 2;
                                __pyx_t_40 = ((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_stars.rcbuffer->pybuffer.buf, __pyx_t_38, __pyx_pybuffernd_stars.diminfo[0].strides, __pyx_t_39, __pyx_pybuffernd_stars.diminfo[1].strides)) * __pyx_v_dx);
                                if (unlikely(__pyx_v_r == 0)) {
                                  #ifdef WITH_THREAD
                                  PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
                                  #endif
                                ...
                                __pyx_t_43 = 0;
                                *__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_rays.rcbuffer->pybuffer.buf, __pyx_t_41, __pyx_pybuffernd_rays.diminfo[0].strides, __pyx_t_42, __pyx_pybuffernd_rays.diminfo[1].strides, __pyx_t_43, __pyx_pybuffernd_rays.diminfo[2].strides) -= (__pyx_t_40 / __pyx_v_r);

                                /* "engine/micro_ray_tracer.pyx":51
 *                 r = dx*dx + dy*dy
 *                 rays[i,j,0] -= stars[s,2]*dx/r
 *                 rays[i,j,1] -= stars[s,2]*dy/r             # <<<<<<<<<<<<<<
 *             # traced_ray = ray_trace_helper(
 ...
 */
                                ...
                                __pyx_t_45 = 2;
                                __pyx_t_40 = ((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_stars.rcbuffer->pybuffer.buf, __pyx_t_44, __pyx_pybuffernd_stars.diminfo[0].strides, __pyx_t_45, __pyx_pybuffernd_stars.diminfo[1].strides)) * __pyx_v_dy);
                                if (unlikely(__pyx_v_r == 0)) {
                                  #ifdef WITH_THREAD
                                  PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
                                  #endif
                                ...
                                __pyx_t_48 = 1;
                                *__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_rays.rcbuffer->pybuffer.buf, __pyx_t_46, __pyx_pybuffernd_rays.diminfo[0].strides, __pyx_t_47, __pyx_pybuffernd_rays.diminfo[1].strides, __pyx_t_48, __pyx_pybuffernd_rays.diminfo[2].strides) -= (__pyx_t_40 / __pyx_v_r);
                              }
                            }
                            goto __pyx_L15;
                            __pyx_L8_error:;
                            ...
                            #endif /* _OPENMP */
                            {
                                __pyx_parallel_temp0 = __pyx_v_dx;
                                __pyx_parallel_temp1 = __pyx_v_dy;
                    ...
                    #else
{
            ...
            if (__pyx_parallel_why) {
              __pyx_v_dx = __pyx_parallel_temp0;
              __pyx_v_dy = __pyx_parallel_temp1;
 ...
 */
  ...
  /* "engine/micro_ray_tracer.pyx":59
 *             # rays[i,j,0] = retx
 *             # rays[i,j,1] = rety
 *     return rays             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_AddTraceback("engine.micro_ray_tracer.ray_trace", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_rays.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_6engine_16micro_ray_tracer_1ray_trace(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6engine_16micro_ray_tracer_ray_trace[] = "ray_trace(ndarray rays, double kap, double gam, int thread_count, ndarray stars) -> ndarray";
static PyObject *__pyx_pw_6engine_16micro_ray_tracer_1ray_trace(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("ray_trace (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_kap)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("ray_trace", 1, 5, 5, 1); __PYX_ERR(0, 29, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_gam)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("ray_trace", 1, 5, 5, 2); __PYX_ERR(0, 29, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_thread_count)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("ray_trace", 1, 5, 5, 3); __PYX_ERR(0, 29, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_stars)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("ray_trace", 1, 5, 5, 4); __PYX_ERR(0, 29, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "ray_trace") < 0)) __PYX_ERR(0, 29, __pyx_L3_error)
      }
    ...
    __pyx_v_thread_count = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_thread_count == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 32, __pyx_L3_error)
    __pyx_v_stars = ((PyArrayObject *)values[4]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("ray_trace", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 29, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("engine.micro_ray_tracer.ray_trace", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_rays), __pyx_ptype_5numpy_ndarray, 1, "rays", 0))) __PYX_ERR(0, 29, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_stars), __pyx_ptype_5numpy_ndarray, 1, "stars", 0))) __PYX_ERR(0, 33, __pyx_L1_error)
  __pyx_r = __pyx_pf_6engine_16micro_ray_tracer_ray_trace(__pyx_self, __pyx_v_rays, __pyx_v_kap, __pyx_v_gam, __pyx_v_thread_count, __pyx_v_stars);
...
static PyObject *__pyx_pf_6engine_16micro_ray_tracer_ray_trace(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_rays, double __pyx_v_kap, double __pyx_v_gam, int __pyx_v_thread_count, PyArrayObject *__pyx_v_stars) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_rays;
  __Pyx_Buffer __pyx_pybuffer_rays;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_stars;
  __Pyx_Buffer __pyx_pybuffer_stars;
  ...
  __Pyx_RefNannySetupContext("ray_trace", 0);
  __Pyx_TraceCall("ray_trace (wrapper)", __pyx_f[0], 29, 0, __PYX_ERR(0, 29, __pyx_L1_error));
  __pyx_pybuffer_rays.pybuffer.buf = NULL;
  __pyx_pybuffer_rays.refcount = 0;
  __pyx_pybuffernd_rays.data = NULL;
  __pyx_pybuffernd_rays.rcbuffer = &__pyx_pybuffer_rays;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_rays.rcbuffer->pybuffer, (PyObject*)__pyx_v_rays, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 3, 0, __pyx_stack) == -1)) __PYX_ERR(0, 29, __pyx_L1_error)
  }
  __pyx_pybuffernd_rays.diminfo[0].strides = __pyx_pybuffernd_rays.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_rays.diminfo[0].shape = __pyx_pybuffernd_rays.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_rays.diminfo[1].strides = __pyx_pybuffernd_rays.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_rays.diminfo[1].shape = __pyx_pybuffernd_rays.rcbuffer->pybuffer.shape[1]; __pyx_pybuffernd_rays.diminfo[2].strides = __pyx_pybuffernd_rays.rcbuffer->pybuffer.strides[2]; __pyx_pybuffernd_rays.diminfo[2].shape = __pyx_pybuffernd_rays.rcbuffer->pybuffer.shape[2];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
  ...
  __pyx_t_1 = ((PyObject *)__pyx_f_6engine_16micro_ray_tracer_ray_trace(((PyArrayObject *)__pyx_v_rays), __pyx_v_kap, __pyx_v_gam, __pyx_v_thread_count, ((PyArrayObject *)__pyx_v_stars), 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 29, __pyx_L1_error)
...
static int __pyx_array___pyx_pf_15View_dot_MemoryView_5array___cinit__(struct __pyx_array_obj *__pyx_v_self, PyObject *__pyx_v_shape, Py_ssize_t __pyx_v_itemsize, PyObject *__pyx_v_format, PyObject *__pyx_v_mode, int __pyx_v_allocate_buffer) {
  ...
  __Pyx_TraceCall("__cinit__", __pyx_f[2], 121, 0, __PYX_ERR(2, 121, __pyx_L1_error));
...
static int __pyx_array___pyx_pf_15View_dot_MemoryView_5array_2__getbuffer__(struct __pyx_array_obj *__pyx_v_self, Py_buffer *__pyx_v_info, int __pyx_v_flags) {
  ...
  __pyx_v_info->obj = Py_None; __Pyx_INCREF(Py_None);
  __Pyx_GIVEREF(__pyx_v_info->obj);
  __Pyx_TraceCall("__getbuffer__", __pyx_f[2], 184, 0, __PYX_ERR(2, 184, __pyx_L1_error));
...
static void __pyx_array___pyx_pf_15View_dot_MemoryView_5array_4__dealloc__(struct __pyx_array_obj *__pyx_v_self) {
  ...
  __Pyx_TraceCall("__dealloc__", __pyx_f[2], 210, 0, __PYX_ERR(2, 210, __pyx_L1_error));
...
static PyObject *__pyx_pf_15View_dot_MemoryView_5array_7memview___get__(struct __pyx_array_obj *__pyx_v_self) {
  ...
  __Pyx_TraceCall("__get__", __pyx_f[2], 221, 0, __PYX_ERR(2, 221, __pyx_L1_error));
...
static PyObject *__pyx_array_get_memview(struct __pyx_array_obj *__pyx_v_self) {
  ...
  __Pyx_TraceCall("get_memview", __pyx_f[2], 225, 0, __PYX_ERR(2, 225, __pyx_L1_error));
...
static Py_ssize_t __pyx_array___pyx_pf_15View_dot_MemoryView_5array_6__len__(struct __pyx_array_obj *__pyx_v_self) {
  ...
  __Pyx_TraceCall("__len__", __pyx_f[2], 229, 0, __PYX_ERR(2, 229, __pyx_L1_error));
...
static PyObject *__pyx_array___pyx_pf_15View_dot_MemoryView_5array_8__getattr__(struct __pyx_array_obj *__pyx_v_self, PyObject *__pyx_v_attr) {
  ...
  __Pyx_TraceCall("__getattr__", __pyx_f[2], 232, 0, __PYX_ERR(2, 232, __pyx_L1_error));
...
static PyObject *__pyx_array___pyx_pf_15View_dot_MemoryView_5array_10__getitem__(struct __pyx_array_obj *__pyx_v_self, PyObject *__pyx_v_item) {
  ...
  __Pyx_TraceCall("__getitem__", __pyx_f[2], 235, 0, __PYX_ERR(2, 235, __pyx_L1_error));
...
static int __pyx_array___pyx_pf_15View_dot_MemoryView_5array_12__setitem__(struct __pyx_array_obj *__pyx_v_self, PyObject *__pyx_v_item, PyObject *__pyx_v_value) {
  ...
  __Pyx_TraceCall("__setitem__", __pyx_f[2], 238, 0, __PYX_ERR(2, 238, __pyx_L1_error));
...
static struct __pyx_array_obj *__pyx_array_new(PyObject *__pyx_v_shape, Py_ssize_t __pyx_v_itemsize, char *__pyx_v_format, char *__pyx_v_mode, char *__pyx_v_buf) {
  ...
  __Pyx_TraceCall("array_cwrapper", __pyx_f[2], 243, 0, __PYX_ERR(2, 243, __pyx_L1_error));
...
static int __pyx_MemviewEnum___pyx_pf_15View_dot_MemoryView_4Enum___init__(struct __pyx_MemviewEnum_obj *__pyx_v_self, PyObject *__pyx_v_name) {
  ...
  __Pyx_TraceCall("__init__", __pyx_f[2], 280, 0, __PYX_ERR(2, 280, __pyx_L1_error));
...
static PyObject *__pyx_MemviewEnum___pyx_pf_15View_dot_MemoryView_4Enum_2__repr__(struct __pyx_MemviewEnum_obj *__pyx_v_self) {
  ...
  __Pyx_TraceCall("__repr__", __pyx_f[2], 282, 0, __PYX_ERR(2, 282, __pyx_L1_error));
...
static void *__pyx_align_pointer(void *__pyx_v_memory, size_t __pyx_v_alignment) {
  ...
  __Pyx_TraceDeclarations
  int __pyx_t_1;
  __Pyx_TraceCall("align_pointer", __pyx_f[2], 297, 1, __PYX_ERR(2, 297, __pyx_L1_error));
...
static int __pyx_memoryview___pyx_pf_15View_dot_MemoryView_10memoryview___cinit__(struct __pyx_memoryview_obj *__pyx_v_self, PyObject *__pyx_v_obj, int __pyx_v_flags, int __pyx_v_dtype_is_object) {
  ...
  int __pyx_t_4;
  __Pyx_RefNannySetupContext("__cinit__", 0);
  __Pyx_TraceCall("__cinit__", __pyx_f[2], 344, 0, __PYX_ERR(2, 344, __pyx_L1_error));
...
static void __pyx_memoryview___pyx_pf_15View_dot_MemoryView_10memoryview_2__dealloc__(struct __pyx_memoryview_obj *__pyx_v_self) {
  ...
  __Pyx_RefNannySetupContext("__dealloc__", 0);
  __Pyx_TraceCall("__dealloc__", __pyx_f[2], 371, 0, __PYX_ERR(2, 371, __pyx_L1_error));
...
static char *__pyx_memoryview_get_item_pointer(struct __pyx_memoryview_obj *__pyx_v_self, PyObject *__pyx_v_index) {
  ...
  __Pyx_TraceCall("get_item_pointer", __pyx_f[2], 388, 0, __PYX_ERR(2, 388, __pyx_L1_error));
...
static PyObject *__pyx_memoryview___pyx_pf_15View_dot_MemoryView_10memoryview_4__getitem__(struct __pyx_memoryview_obj *__pyx_v_self, PyObject *__pyx_v_index) {
  ...
  char *__pyx_t_6;
  __Pyx_RefNannySetupContext("__getitem__", 0);
  __Pyx_TraceCall("__getitem__", __pyx_f[2], 398, 0, __PYX_ERR(2, 398, __pyx_L1_error));
...
static int __pyx_memoryview___pyx_pf_15View_dot_MemoryView_10memoryview_6__setitem__(struct __pyx_memoryview_obj *__pyx_v_self, PyObject *__pyx_v_index, PyObject *__pyx_v_value) {
  ...
  PyObject *__pyx_t_4 = NULL;
  __Pyx_RefNannySetupContext("__setitem__", 0);
  __Pyx_TraceCall("__setitem__", __pyx_f[2], 411, 0, __PYX_ERR(2, 411, __pyx_L1_error));
...
static PyObject *__pyx_memoryview_is_slice(struct __pyx_memoryview_obj *__pyx_v_self, PyObject *__pyx_v_obj) {
  ...
  __Pyx_TraceCall("is_slice", __pyx_f[2], 426, 0, __PYX_ERR(2, 426, __pyx_L1_error));
  __Pyx_INCREF(__pyx_v_obj);
...
static PyObject *__pyx_memoryview_setitem_slice_assignment(struct __pyx_memoryview_obj *__pyx_v_self, PyObject *__pyx_v_dst, PyObject *__pyx_v_src) {
  ...
  __Pyx_TraceCall("setitem_slice_assignment", __pyx_f[2], 436, 0, __PYX_ERR(2, 436, __pyx_L1_error));
...
static PyObject *__pyx_memoryview_setitem_slice_assign_scalar(struct __pyx_memoryview_obj *__pyx_v_self, struct __pyx_memoryview_obj *__pyx_v_dst, PyObject *__pyx_v_value) {
  ...
  __Pyx_TraceCall("setitem_slice_assign_scalar", __pyx_f[2], 444, 0, __PYX_ERR(2, 444, __pyx_L1_error));
...
static PyObject *__pyx_memoryview_setitem_indexed(struct __pyx_memoryview_obj *__pyx_v_self, PyObject *__pyx_v_index, PyObject *__pyx_v_value) {
  ...
  __Pyx_TraceCall("setitem_indexed", __pyx_f[2], 476, 0, __PYX_ERR(2, 476, __pyx_L1_error));
...
static PyObject *__pyx_memoryview_convert_item_to_object(struct __pyx_memoryview_obj *__pyx_v_self, char *__pyx_v_itemp) {
  ...
  __Pyx_TraceCall("convert_item_to_object", __pyx_f[2], 480, 0, __PYX_ERR(2, 480, __pyx_L1_error));
...
static PyObject *__pyx_memoryview_assign_item_from_object(struct __pyx_memoryview_obj *__pyx_v_self, char *__pyx_v_itemp, PyObject *__pyx_v_value) {
  ...
  __Pyx_TraceCall("assign_item_from_object", __pyx_f[2], 496, 0, __PYX_ERR(2, 496, __pyx_L1_error));
...
static int __pyx_memoryview___pyx_pf_15View_dot_MemoryView_10memoryview_8__getbuffer__(struct __pyx_memoryview_obj *__pyx_v_self, Py_buffer *__pyx_v_info, int __pyx_v_flags) {
  ...
  __pyx_v_info->obj = Py_None; __Pyx_INCREF(Py_None);
  __Pyx_GIVEREF(__pyx_v_info->obj);
  __Pyx_TraceCall("__getbuffer__", __pyx_f[2], 513, 0, __PYX_ERR(2, 513, __pyx_L1_error));
...
static PyObject *__pyx_pf_15View_dot_MemoryView_10memoryview_1T___get__(struct __pyx_memoryview_obj *__pyx_v_self) {
  ...
  int __pyx_t_2;
  __Pyx_RefNannySetupContext("__get__", 0);
  __Pyx_TraceCall("__get__", __pyx_f[2], 548, 0, __PYX_ERR(2, 548, __pyx_L1_error));
...
static PyObject *__pyx_pf_15View_dot_MemoryView_10memoryview_4base___get__(struct __pyx_memoryview_obj *__pyx_v_self) {
  ...
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__", 0);
  __Pyx_TraceCall("__get__", __pyx_f[2], 554, 0, __PYX_ERR(2, 554, __pyx_L1_error));
...
static PyObject *__pyx_pf_15View_dot_MemoryView_10memoryview_5shape___get__(struct __pyx_memoryview_obj *__pyx_v_self) {
  ...
  PyObject *__pyx_t_5 = NULL;
  __Pyx_RefNannySetupContext("__get__", 0);
  __Pyx_TraceCall("__get__", __pyx_f[2], 558, 0, __PYX_ERR(2, 558, __pyx_L1_error));
...
static PyObject *__pyx_pf_15View_dot_MemoryView_10memoryview_7strides___get__(struct __pyx_memoryview_obj *__pyx_v_self) {
  ...
  PyObject *__pyx_t_6 = NULL;
  __Pyx_RefNannySetupContext("__get__", 0);
  __Pyx_TraceCall("__get__", __pyx_f[2], 562, 0, __PYX_ERR(2, 562, __pyx_L1_error));
...
static PyObject *__pyx_pf_15View_dot_MemoryView_10memoryview_8itemsize___get__(struct __pyx_memoryview_obj *__pyx_v_self) {
  ...
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("__get__", 0);
  __Pyx_TraceCall("__get__", __pyx_f[2], 581, 0, __PYX_ERR(2, 581, __pyx_L1_error));
...
static PyObject *__pyx_pf_15View_dot_MemoryView_10memoryview_6nbytes___get__(struct __pyx_memoryview_obj *__pyx_v_self) {
  ...
  PyObject *__pyx_t_3 = NULL;
  __Pyx_RefNannySetupContext("__get__", 0);
  __Pyx_TraceCall("__get__", __pyx_f[2], 585, 0, __PYX_ERR(2, 585, __pyx_L1_error));
...
static PyObject *__pyx_pf_15View_dot_MemoryView_10memoryview_4size___get__(struct __pyx_memoryview_obj *__pyx_v_self) {
  ...
  PyObject *__pyx_t_6 = NULL;
  __Pyx_RefNannySetupContext("__get__", 0);
  __Pyx_TraceCall("__get__", __pyx_f[2], 589, 0, __PYX_ERR(2, 589, __pyx_L1_error));
...
static Py_ssize_t __pyx_memoryview___pyx_pf_15View_dot_MemoryView_10memoryview_10__len__(struct __pyx_memoryview_obj *__pyx_v_self) {
  ...
  int __pyx_t_1;
  __Pyx_RefNannySetupContext("__len__", 0);
  __Pyx_TraceCall("__len__", __pyx_f[2], 600, 0, __PYX_ERR(2, 600, __pyx_L1_error));
...
static PyObject *__pyx_memoryview___pyx_pf_15View_dot_MemoryView_10memoryview_12__repr__(struct __pyx_memoryview_obj *__pyx_v_self) {
  ...
  PyObject *__pyx_t_3 = NULL;
  __Pyx_RefNannySetupContext("__repr__", 0);
  __Pyx_TraceCall("__repr__", __pyx_f[2], 606, 0, __PYX_ERR(2, 606, __pyx_L1_error));
...
static PyObject *__pyx_memoryview___pyx_pf_15View_dot_MemoryView_10memoryview_14__str__(struct __pyx_memoryview_obj *__pyx_v_self) {
  ...
  __Pyx_TraceCall("__str__", __pyx_f[2], 610, 0, __PYX_ERR(2, 610, __pyx_L1_error));
...
static PyObject *__pyx_memoryview___pyx_pf_15View_dot_MemoryView_10memoryview_16is_c_contig(struct __pyx_memoryview_obj *__pyx_v_self) {
  ...
  __Pyx_TraceCall("is_c_contig", __pyx_f[2], 614, 0, __PYX_ERR(2, 614, __pyx_L1_error));
...
static PyObject *__pyx_memoryview___pyx_pf_15View_dot_MemoryView_10memoryview_18is_f_contig(struct __pyx_memoryview_obj *__pyx_v_self) {
  ...
  __Pyx_TraceCall("is_f_contig", __pyx_f[2], 620, 0, __PYX_ERR(2, 620, __pyx_L1_error));
...
static PyObject *__pyx_memoryview___pyx_pf_15View_dot_MemoryView_10memoryview_20copy(struct __pyx_memoryview_obj *__pyx_v_self) {
  ...
  __Pyx_TraceCall("copy", __pyx_f[2], 626, 0, __PYX_ERR(2, 626, __pyx_L1_error));
...
static PyObject *__pyx_memoryview___pyx_pf_15View_dot_MemoryView_10memoryview_22copy_fortran(struct __pyx_memoryview_obj *__pyx_v_self) {
  ...
  __Pyx_TraceCall("copy_fortran", __pyx_f[2], 638, 0, __PYX_ERR(2, 638, __pyx_L1_error));
...
static PyObject *__pyx_memoryview_new(PyObject *__pyx_v_o, int __pyx_v_flags, int __pyx_v_dtype_is_object, __Pyx_TypeInfo *__pyx_v_typeinfo) {
  ...
  __Pyx_TraceCall("memoryview_cwrapper", __pyx_f[2], 652, 0, __PYX_ERR(2, 652, __pyx_L1_error));
...
static CYTHON_INLINE int __pyx_memoryview_check(PyObject *__pyx_v_o) {
  ...
  __Pyx_TraceCall("memoryview_check", __pyx_f[2], 658, 0, __PYX_ERR(2, 658, __pyx_L1_error));
...
static PyObject *_unellipsify(PyObject *__pyx_v_index, int __pyx_v_ndim) {
  ...
  __Pyx_TraceCall("_unellipsify", __pyx_f[2], 661, 0, __PYX_ERR(2, 661, __pyx_L1_error));
...
static PyObject *assert_direct_dimensions(Py_ssize_t *__pyx_v_suboffsets, int __pyx_v_ndim) {
  ...
  __Pyx_TraceCall("assert_direct_dimensions", __pyx_f[2], 695, 0, __PYX_ERR(2, 695, __pyx_L1_error));
...
static struct __pyx_memoryview_obj *__pyx_memview_slice(struct __pyx_memoryview_obj *__pyx_v_memview, PyObject *__pyx_v_indices) {
  ...
  __Pyx_TraceCall("memview_slice", __pyx_f[2], 705, 0, __PYX_ERR(2, 705, __pyx_L1_error));
...
static int __pyx_memoryview_slice_memviewslice(__Pyx_memviewslice *__pyx_v_dst, Py_ssize_t __pyx_v_shape, Py_ssize_t __pyx_v_stride, Py_ssize_t __pyx_v_suboffset, int __pyx_v_dim, int __pyx_v_new_ndim, int *__pyx_v_suboffset_dim, Py_ssize_t __pyx_v_start, Py_ssize_t __pyx_v_stop, Py_ssize_t __pyx_v_step, int __pyx_v_have_start, int __pyx_v_have_stop, int __pyx_v_have_step, int __pyx_v_is_slice) {
  ...
  int __pyx_t_2;
  int __pyx_t_3;
  __Pyx_TraceCall("slice_memviewslice", __pyx_f[2], 802, 1, __PYX_ERR(2, 802, __pyx_L1_error));
...
static char *__pyx_pybuffer_index(Py_buffer *__pyx_v_view, char *__pyx_v_bufp, Py_ssize_t __pyx_v_index, Py_ssize_t __pyx_v_dim) {
  ...
  __Pyx_TraceCall("pybuffer_index", __pyx_f[2], 905, 0, __PYX_ERR(2, 905, __pyx_L1_error));
...
static int __pyx_memslice_transpose(__Pyx_memviewslice *__pyx_v_memslice) {
  ...
  int __pyx_t_8;
  int __pyx_t_9;
  __Pyx_TraceCall("transpose_memslice", __pyx_f[2], 938, 1, __PYX_ERR(2, 938, __pyx_L1_error));
...
static void __pyx_memoryviewslice___pyx_pf_15View_dot_MemoryView_16_memoryviewslice___dealloc__(struct __pyx_memoryviewslice_obj *__pyx_v_self) {
  ...
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__dealloc__", 0);
  __Pyx_TraceCall("__dealloc__", __pyx_f[2], 971, 0, __PYX_ERR(2, 971, __pyx_L1_error));
...
static PyObject *__pyx_memoryviewslice_convert_item_to_object(struct __pyx_memoryviewslice_obj *__pyx_v_self, char *__pyx_v_itemp) {
  ...
  PyObject *__pyx_t_2 = NULL;
  __Pyx_RefNannySetupContext("convert_item_to_object", 0);
  __Pyx_TraceCall("convert_item_to_object", __pyx_f[2], 974, 0, __PYX_ERR(2, 974, __pyx_L1_error));
...
static PyObject *__pyx_memoryviewslice_assign_item_from_object(struct __pyx_memoryviewslice_obj *__pyx_v_self, char *__pyx_v_itemp, PyObject *__pyx_v_value) {
  ...
  PyObject *__pyx_t_3 = NULL;
  __Pyx_RefNannySetupContext("assign_item_from_object", 0);
  __Pyx_TraceCall("assign_item_from_object", __pyx_f[2], 980, 0, __PYX_ERR(2, 980, __pyx_L1_error));
...
static PyObject *__pyx_pf_15View_dot_MemoryView_16_memoryviewslice_4base___get__(struct __pyx_memoryviewslice_obj *__pyx_v_self) {
  ...
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__", 0);
  __Pyx_TraceCall("__get__", __pyx_f[2], 987, 0, __PYX_ERR(2, 987, __pyx_L1_error));
...
static PyObject *__pyx_memoryview_fromslice(__Pyx_memviewslice __pyx_v_memviewslice, int __pyx_v_ndim, PyObject *(*__pyx_v_to_object_func)(char *), int (*__pyx_v_to_dtype_func)(char *, PyObject *), int __pyx_v_dtype_is_object) {
  ...
  __Pyx_TraceCall("memoryview_fromslice", __pyx_f[2], 994, 0, __PYX_ERR(2, 994, __pyx_L1_error));
...
static __Pyx_memviewslice *__pyx_memoryview_get_slice_from_memoryview(struct __pyx_memoryview_obj *__pyx_v_memview, __Pyx_memviewslice *__pyx_v_mslice) {
  ...
  __Pyx_TraceCall("get_slice_from_memview", __pyx_f[2], 1047, 0, __PYX_ERR(2, 1047, __pyx_L1_error));
...
static void __pyx_memoryview_slice_copy(struct __pyx_memoryview_obj *__pyx_v_memview, __Pyx_memviewslice *__pyx_v_dst) {
  ...
  __Pyx_TraceCall("slice_copy", __pyx_f[2], 1058, 0, __PYX_ERR(2, 1058, __pyx_L1_error));
...
static PyObject *__pyx_memoryview_copy_object(struct __pyx_memoryview_obj *__pyx_v_memview) {
  ...
  __Pyx_TraceCall("memoryview_copy", __pyx_f[2], 1075, 0, __PYX_ERR(2, 1075, __pyx_L1_error));
...
static PyObject *__pyx_memoryview_copy_object_from_slice(struct __pyx_memoryview_obj *__pyx_v_memview, __Pyx_memviewslice *__pyx_v_memviewslice) {
  ...
  __Pyx_TraceCall("memoryview_copy_from_slice", __pyx_f[2], 1082, 0, __PYX_ERR(2, 1082, __pyx_L1_error));
...
static Py_ssize_t abs_py_ssize_t(Py_ssize_t __pyx_v_arg) {
  ...
  __Pyx_TraceDeclarations
  int __pyx_t_1;
  __Pyx_TraceCall("abs_py_ssize_t", __pyx_f[2], 1104, 1, __PYX_ERR(2, 1104, __pyx_L1_error));
...
static char __pyx_get_best_slice_order(__Pyx_memviewslice *__pyx_v_mslice, int __pyx_v_ndim) {
  ...
  int __pyx_t_3;
  int __pyx_t_4;
  __Pyx_TraceCall("get_best_order", __pyx_f[2], 1111, 1, __PYX_ERR(2, 1111, __pyx_L1_error));
...
static void copy_strided_to_strided(__Pyx_memviewslice *__pyx_v_src, __Pyx_memviewslice *__pyx_v_dst, int __pyx_v_ndim, size_t __pyx_v_itemsize) {
  __Pyx_TraceDeclarations
  __Pyx_TraceCall("copy_strided_to_strided", __pyx_f[2], 1165, 1, __PYX_ERR(2, 1165, __pyx_L1_error));
...
static Py_ssize_t __pyx_memoryview_slice_get_size(__Pyx_memviewslice *__pyx_v_src, int __pyx_v_ndim) {
  ...
  int __pyx_t_3;
  int __pyx_t_4;
  __Pyx_TraceCall("slice_get_size", __pyx_f[2], 1172, 1, __PYX_ERR(2, 1172, __pyx_L1_error));
...
static Py_ssize_t __pyx_fill_contig_strides_array(Py_ssize_t *__pyx_v_shape, Py_ssize_t *__pyx_v_strides, Py_ssize_t __pyx_v_stride, int __pyx_v_ndim, char __pyx_v_order) {
  ...
  int __pyx_t_3;
  int __pyx_t_4;
  __Pyx_TraceCall("fill_contig_strides_array", __pyx_f[2], 1183, 1, __PYX_ERR(2, 1183, __pyx_L1_error));
...
static void *__pyx_memoryview_copy_data_to_temp(__Pyx_memviewslice *__pyx_v_src, __Pyx_memviewslice *__pyx_v_tmpslice, char __pyx_v_order, int __pyx_v_ndim) {
  ...
  int __pyx_t_5;
  int __pyx_t_6;
  __Pyx_TraceCall("copy_data_to_temp", __pyx_f[2], 1204, 1, __PYX_ERR(2, 1204, __pyx_L1_error));
...
static int __pyx_memoryview_err_extents(int __pyx_v_i, Py_ssize_t __pyx_v_extent1, Py_ssize_t __pyx_v_extent2) {
  ...
  __Pyx_TraceCall("_err_extents", __pyx_f[2], 1247, 0, __PYX_ERR(2, 1247, __pyx_L1_error));
...
static int __pyx_memoryview_err_dim(PyObject *__pyx_v_error, char *__pyx_v_msg, int __pyx_v_dim) {
  ...
  __Pyx_TraceCall("_err_dim", __pyx_f[2], 1253, 0, __PYX_ERR(2, 1253, __pyx_L1_error));
...
static int __pyx_memoryview_err(PyObject *__pyx_v_error, char *__pyx_v_msg) {
  ...
  __Pyx_TraceCall("_err", __pyx_f[2], 1257, 0, __PYX_ERR(2, 1257, __pyx_L1_error));
  __Pyx_INCREF(__pyx_v_error);
...
static int __pyx_memoryview_copy_contents(__Pyx_memviewslice __pyx_v_src, __Pyx_memviewslice __pyx_v_dst, int __pyx_v_src_ndim, int __pyx_v_dst_ndim, int __pyx_v_dtype_is_object) {
  ...
  void *__pyx_t_7;
  int __pyx_t_8;
  __Pyx_TraceCall("memoryview_copy_contents", __pyx_f[2], 1264, 1, __PYX_ERR(2, 1264, __pyx_L1_error));
...
static void __pyx_memoryview_broadcast_leading(__Pyx_memviewslice *__pyx_v_mslice, int __pyx_v_ndim, int __pyx_v_ndim_other) {
  ...
  int __pyx_t_2;
  int __pyx_t_3;
  __Pyx_TraceCall("broadcast_leading", __pyx_f[2], 1336, 1, __PYX_ERR(2, 1336, __pyx_L1_error));
...
static void __pyx_memoryview_refcount_copying(__Pyx_memviewslice *__pyx_v_dst, int __pyx_v_dtype_is_object, int __pyx_v_ndim, int __pyx_v_inc) {
  __Pyx_TraceDeclarations
  int __pyx_t_1;
  __Pyx_TraceCall("refcount_copying", __pyx_f[2], 1358, 1, __PYX_ERR(2, 1358, __pyx_L1_error));
...
static void __pyx_memoryview_refcount_objects_in_slice_with_gil(char *__pyx_v_data, Py_ssize_t *__pyx_v_shape, Py_ssize_t *__pyx_v_strides, int __pyx_v_ndim, int __pyx_v_inc) {
  ...
  __Pyx_TraceCall("refcount_objects_in_slice_with_gil", __pyx_f[2], 1367, 0, __PYX_ERR(2, 1367, __pyx_L1_error));
...
static void __pyx_memoryview_refcount_objects_in_slice(char *__pyx_v_data, Py_ssize_t *__pyx_v_shape, Py_ssize_t *__pyx_v_strides, int __pyx_v_ndim, int __pyx_v_inc) {
  ...
  __Pyx_TraceCall("refcount_objects_in_slice", __pyx_f[2], 1373, 0, __PYX_ERR(2, 1373, __pyx_L1_error));
...
static void __pyx_memoryview_slice_assign_scalar(__Pyx_memviewslice *__pyx_v_dst, int __pyx_v_ndim, size_t __pyx_v_itemsize, void *__pyx_v_item, int __pyx_v_dtype_is_object) {
  __Pyx_TraceDeclarations
  __Pyx_TraceCall("slice_assign_scalar", __pyx_f[2], 1393, 1, __PYX_ERR(2, 1393, __pyx_L1_error));
...
static void __pyx_memoryview__slice_assign_scalar(char *__pyx_v_data, Py_ssize_t *__pyx_v_shape, Py_ssize_t *__pyx_v_strides, int __pyx_v_ndim, size_t __pyx_v_itemsize, void *__pyx_v_item) {
  ...
  Py_ssize_t __pyx_t_3;
  Py_ssize_t __pyx_t_4;
  __Pyx_TraceCall("_slice_assign_scalar", __pyx_f[2], 1403, 1, __PYX_ERR(2, 1403, __pyx_L1_error));
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "engine.micro_ray_tracer.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "engine.micro_ray_tracer.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "engine.micro_ray_tracer.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "engine.micro_ray_tracer._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"ray_trace", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6engine_16micro_ray_tracer_1ray_trace, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6engine_16micro_ray_tracer_ray_trace},
  {0, 0, 0, 0}
};
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("ray_trace", (void (*)(void))__pyx_f_6engine_16micro_ray_tracer_ray_trace, "PyArrayObject *(PyArrayObject *, double &, double &, int &, PyArrayObject *, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_engine__micro_ray_tracer) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "engine.micro_ray_tracer")) {
      if (unlikely(PyDict_SetItemString(modules, "engine.micro_ray_tracer", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  #endif
  __Pyx_TraceCall("__Pyx_PyMODINIT_FUNC PyInit_micro_ray_tracer(void)", __pyx_f[0], 1, 0, __PYX_ERR(0, 1, __pyx_L1_error));

  /* "engine/micro_ray_tracer.pyx":6
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init engine.micro_ray_tracer", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init engine.micro_ray_tracer");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
