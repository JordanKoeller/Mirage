...
from mirage.util import Jsonable, Vec2D, PolarVec, PixelRegion, Region, zero_vector, CircularRegion
# from mirage.calculator import StarGenerator
...
class MicrolensingParameters(Parameters):
	...
	def eta_0(self):
		...
		# tmp = (1*self.theta_E).to('rad').value
		# rat = (self.dS/self.dL).value
		# eta = u.def_unit('eta',tmp*rat*u.rad)
		# return eta
	...
	def stars(self):
		...
		return self.star_generator.generate_stars(region,mass_density*self.percent_stars,center_on_zero=True)
