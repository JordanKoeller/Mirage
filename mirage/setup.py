...
if __name__ =="__main__":
    ...
    micro_ray_tracer = Extension("engine.micro_ray_tracer", sources = ["engine/micro_ray_tracer.pyx"], language = "c++",    extra_compile_args=["-std=c++11","-fopenmp"], extra_link_args=["-std=c++11","-Ofast"], libraries = ["m"])
