...
class ParametersWidget(UserInputWidget):
  ...
  def get_object(self, *args, **kwargs):
    ...
    try:
      ...
      UserInputWidget.warn_user(
        "Error constructing the Parameters object. Please validate input and try again.")
  ...
  def get_object(self, *args, **kwargs):
    ...
    if parameters:
      ...
      try:
        ...
        UserInputWidget.warn_user(
          "Unknown error encountered in trial variance input. Please validate and try again.")
      return None
